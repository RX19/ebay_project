...
CREATE TABLE C##EBAY.TBL_PUNTUACIONES (
    ID_PUNTUACION NUMBER NOT NULL,
    PUNTAJE       NUMBER NOT NULL,
    DESCRIPCION   VARCHAR2(255)
);

ALTER TABLE C##EBAY.TBL_PUNTUACIONES ADD CONSTRAINT PUNTUACION_PK PRIMARY KEY (ID_PUNTUACION);
...
ALTER TABLE C##EBAY.TBL_ARTICULO
    ADD CONSTRAINT FK_ARTICULO_PUNTUACIONES FOREIGN KEY (ID_PUNTUACION_ARTICULO)
        REFERENCES C##EBAY.TBL_PUNTUACIONES (ID_PUNTUACION);
